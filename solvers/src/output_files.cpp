...
void Directory_Name()
{
	...
	Solution_File = pwd1 + "/solutions/2D_Euler_Solutions/";
	Final_Solution_File = pwd1 + "/solutions/2D_Euler_Solutions/";
	Initial_Solution_File = pwd1 + "/solutions/2D_Euler_Solutions/";
	Error_File = pwd1 + "/solutions/2D_Euler_Solutions/";
	CF_File = pwd1 + "/solutions/2D_Euler_Solutions/";
...
void CreateTestCaseDirectories(int &Test_Case)
{
	...
	filesystem::path solutionBasePath = basePath / "solutions" / "2D_Euler_Solutions";
