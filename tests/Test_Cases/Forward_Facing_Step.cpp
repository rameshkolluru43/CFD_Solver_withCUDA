...
extern "C" void Forward_Facing_Step()
{
	...
	{
	case 1:
		Grid_File = "../input/Grid_Files/Forward_Step_Grid_Files/Forward_Step_Perfect_Gas_241_81.txt";
		Grid_Vtk_File = "../input/Grid_Files/Forward_Step_Grid_Files/Forward_Step_Perfect_Gas_241_81.vtk";
		...
		break;
	case 2:
		Grid_File = "../input/Grid_Files/Forward_Step_Grid_Files/Forward_Step_Perfect_Gas_121_41.txt";
		Grid_Vtk_File = "../input/Grid_Files/Forward_Step_Grid_Files/Forward_Step_Perfect_Gas_121_41.vtk";
		...
		break;
	case 3:
		Grid_File = "../input/Grid_Files/Forward_Step_Grid_Files/Forward_Step_Perfect_Gas_481_161.txt";
		Grid_Vtk_File = "../input/Grid_Files/Forward_Step_Grid_Files/Forward_Step_Perfect_Gas_481_161.vtk";
		...
		break;
	case 4:
		Grid_File = "../input/Grid_Files/Forward_Step_Grid_Files/Forward_Step_Perfect_Gas_961_321.txt";
		Grid_Vtk_File = "../input/Grid_Files/Forward_Step_Grid_Files/Forward_Step_Perfect_Gas_961_321.vtk";
