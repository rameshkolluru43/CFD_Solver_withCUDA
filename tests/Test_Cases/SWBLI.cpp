...
extern "C" void SWBLI()
{
	...
	case 1:
		Grid_File = "../input/Grid_Files/SWBLI/SWBLI_101_51.txt";
		Grid_Vtk_File = "../input/Grid_Files/SWBLI/SWBLI_101_51.vtk";
		...
		break;
	case 2:
		Grid_File = "../input/Grid_Files/SWBLI/SWBLI_501_251.txt";
		Grid_Vtk_File = "../input/Grid_Files/SWBLI/SWBLI_501_251.vtk";
		...
		break;
	case 3:
		Grid_File = "../input/Grid_Files/SWBLI/SWBLI_1001_501.txt";
		Grid_Vtk_File = "../input/Grid_Files/SWBLI/SWBLI_1001_501.vtk";
		...
		break;
	case 4:
		Grid_File = "../input/Grid_Files/SWBLI/SWBLI_401_201.txt";
		Grid_Vtk_File = "../input/Grid_Files/SWBLI/SWBLI_401_201.vtk";
		...
		break;
	case 5:
		Grid_File = "../input/Grid_Files/SWBLI/SWBLI_801_401.txt";
		Grid_Vtk_File = "../input/Grid_Files/SWBLI/SWBLI_801_401.vtk";
