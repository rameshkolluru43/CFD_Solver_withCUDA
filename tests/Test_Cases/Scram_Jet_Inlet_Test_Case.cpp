...
extern "C" void Scram_Jet_Inlet()
{
	...
	Grid_File = "../input/Grid_Files/Scramjet/Scram_Jet_Inlet_Flow_300_100.txt";
	...
	Write_Cell_Info("../input/Grid_Files/Scramjet/Scram_Jet_Inlet_Flow_Details_300_100.txt");
	V_D V(2, 0.0);
