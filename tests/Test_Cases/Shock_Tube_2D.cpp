...
extern "C" void Shock_Tube_2D()
{
	...
	{
	case 1:
		Grid_File = "../input/Grid_Files/Shock_Tube_Grid_Files/Shock_Tube_2D_SG_Alpha03_501_151.txt";
		Grid_Vtk_File = "../input/Grid_Files/Shock_Tube_Grid_Files/Shock_Tube_2D_SG_Alpha03_501_151.vtk";
		...
		break;
	case 2:
		Grid_File = "../input/Grid_Files/Shock_Tube_Grid_Files/Shock_Tube_2D_SG_Alpha03_1001_301.txt";
		Grid_Vtk_File = "../input/Grid_Files/Shock_Tube_Grid_Files/Shock_Tube_2D_SG_Alpha03_1001_301.vtk";
		...
		break;
	case 3:
		Grid_File = "../input/Grid_Files/Shock_Tube_Grid_Files/Shock_Tube_2D_SG_Alpha03_201_201.txt";
		Grid_Vtk_File = "../input/Grid_Files/Shock_Tube_Grid_Files/Shock_Tube_2D_SG_Alpha03_201_201.vtk";
		...
		break;
	case 4:
		Grid_File = "../input/Grid_Files/Shock_Tube_Grid_Files/Shock_Tube_2D_SG_Alpha03_101_101.txt";
		Grid_Vtk_File = "../input/Grid_Files/Shock_Tube_Grid_Files/Shock_Tube_2D_SG_Alpha03_101_101.vtk";
		...
		break;
	case 5:
		Grid_File = "../input/Grid_Files/Shock_Tube_Grid_Files/Shock_Tube_2D_SG_Alpha03_501_501.txt";
		Grid_Vtk_File = "../input/Grid_Files/Shock_Tube_Grid_Files/Shock_Tube_2D_SG_Alpha03_501_501.vtk";
		...
		break;
	case 6:
		Grid_File = "../input/Grid_Files/Shock_Tube_Grid_Files/SWBLI_L1_2D_513_513.txt";
		Grid_Vtk_File = "../input/Grid_Files/Shock_Tube_Grid_Files/SWBLI_L1_2D_513_513.vtk";
	...
	//	Write_Cell_Info("../input/Grid_Files/Forward_Step_Grid_Files/Forward_Step_241_81.txt");
	V_D V(2, 0.0);
	int index = 0;
