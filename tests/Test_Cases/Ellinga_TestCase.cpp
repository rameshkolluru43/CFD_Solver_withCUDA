...
extern "C" void Ellinga_Carbuncle()
{
	...
	{
		case 1:
			Grid_File = "../input/Grid_Files/EllingCase/EllingCase_101_41.txt";
			Grid_Vtk_File = "../input/Grid_Files/EllingCase/EllingCase_101_41.vtk";
			...
			break;
			case 2:
			Grid_File = "../input/Grid_Files/EllingCase/EllingCase_201_81.txt";
			Grid_Vtk_File = "../input/Grid_Files/EllingCase/EllingCase_201_81.vtk";
			...
			break;
			case 3:
			Grid_File = "../input/Grid_Files/EllingCase/EllingCase_1001_401.txt";
			Grid_Vtk_File = "../input/Grid_Files/EllingCase/EllingCase_1001_401.vtk";
