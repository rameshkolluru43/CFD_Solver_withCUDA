...
extern "C" void Ramp_15_Degree()
{
	...
	{
	case 1:
		Grid_File = "../input/Grid_Files/Ramp_Grid_Files/Ramp_15o_241_81.txt";
		Grid_Vtk_File = "../input/Grid_Files/Ramp_Grid_Files/Ramp_15o_241_81.vtk";
		...
		break;
	case 2:
		Grid_File = "../input/Grid_Files/Ramp_Grid_Files/Ramp_15o_121_41.txt";
		Grid_Vtk_File = "../input/Grid_Files/Ramp_Grid_Files/Ramp_15o_121_41.vtk";
		...
		break;
	case 8:
		Grid_File = "../input/Grid_Files/Ramp_Grid_Files/Ramp_15o_61_21.txt";
		Grid_Vtk_File = "../input/Grid_Files/Ramp_Grid_Files/Ramp_15o_61_21.vtk";
		...
		break;
	case 9:
		Grid_File = "../input/Grid_Files/Ramp_Grid_Files/Ramp_15o_109_37.txt";
		Grid_Vtk_File = "../input/Grid_Files/Ramp_Grid_Files/Ramp_15o_109_37.vtk";
	...
	case 10:
		...
		break;
	case 3:
		Grid_File = "../input/Grid_Files/Ramp_Grid_Files/Ramp_15o_481_161.txt";
		Grid_Vtk_File = "../input/Grid_Files/Ramp_Grid_Files/Ramp_15o_481_161.vtk";
		...
		break;
	case 4:
		Grid_File = "../input/Grid_Files/Ramp_Grid_Files/Ramp_15o_361_121.txt";
		Grid_Vtk_File = "../input/Grid_Files/Ramp_Grid_Files/Ramp_15o_361_121.vtk";
		...
		break;
	case 5:
		Grid_File = "../input/Grid_Files/Ramp_Grid_Files/Viscous_Ramp_15o_801_101.txt";
		Grid_Vtk_File = "../input/Grid_Files/Ramp_Grid_Files/Viscous_Ramp_15o_801_101.vtk";
		...
		break;
	case 6:
		Grid_File = "../input/Grid_Files/Ramp_Grid_Files/Viscous_Ramp_15o_101_301.txt";
		Grid_Vtk_File = "../input/Grid_Files/Ramp_Grid_Files/Viscous_Ramp_15o_101_301.vtk";
		...
		break;
	case 7:
		Grid_File = "../input/Grid_Files/Ramp_Grid_Files/Viscous_Ramp_15o_401_51.txt";
		Grid_Vtk_File = "../input/Grid_Files/Ramp_Grid_Files/Viscous_Ramp_15o_401_51.vtk";
	...
	Write_Cell_Info("../input/Grid_Files/Ramp_Grid_Files/Ramp_Grid_Details_481_161.txt");
	V_D V(2, 0.0);
