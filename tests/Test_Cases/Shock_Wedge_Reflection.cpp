...
extern "C" void Shock_Wedge_Reflection()
{
	...
	{
	case 1:
		Grid_File = "../input/Grid_Files/Ramp_Grid_Files/Shock_Ramp_121_91.txt";
		Grid_Vtk_File = "../input/Grid_Files/Ramp_Grid_Files/Shock_Ramp_121_91.vtk";
		...
		break;
	case 2:
		Grid_File = "../input/Grid_Files/Ramp_Grid_Files/Shock_Ramp_241_181.txt";
		Grid_Vtk_File = "../input/Grid_Files/Ramp_Grid_Files/Shock_Ramp_241_181.vtk";
		...
		break;
	case 3:
		Grid_File = "../input/Grid_Files/Ramp_Grid_Files/Shock_Ramp_481_361.txt";
		Grid_Vtk_File = "../input/Grid_Files/Ramp_Grid_Files/Shock_Ramp_481_361.vtk";
		...
		break;
	case 4:
		Grid_File = "../input/Grid_Files/Ramp_Grid_Files/Shock_Ramp_961_721.txt";
		Grid_Vtk_File = "../input/Grid_Files/Ramp_Grid_Files/Shock_Ramp_961_721.vtk";
	...
	//	Write_Cell_Info("../input/Grid_Files/Ramp_Grid_Files/Ramp_Grid_Details_241_81.txt");
