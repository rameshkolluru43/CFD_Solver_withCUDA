...
extern "C" void Shock_Bubble_Interaction()
{
	...
	Grid_File = "../input/Grid_Files/Channel_Grid_Files/Channel_FLow_Inviscid_101_101.txt";
	Grid_Vtk_File = "../input/Grid_Files/Channel_Grid_Files/Channel_FLow_Inviscid_101_101.vtk";
	/* Reads Input grid file and does the preprocessing required for grid
	 * Calculates the Cell Normals, Cell Areas
	 * Checks for Grid
	 */
	...
	//	Write_Cell_Info("../input/Grid_Files/Channel_Files/Channel_Details_41_21.txt");
