...
extern "C" void Channel_Flow()
{
	...
	Grid_File = "../input/Grid_Files/Channel_Grid_Files/Channle_2D_SG_Alpha03_141_141.txt";
	Grid_Vtk_File = "../input/Grid_Files/Channel_Grid_Files/Channel_2D_SG_Alpha03_141_141.vtk";
